...
export const masterCatalogItems: MasterItem[] = [
  ...
  
  {
    ...
    description: '100% pure cotton fabric, 120 GSM, 45-inch width, premium quality for high-end textile applications',
    ...
    specifications: {
      ...
      processingRequirements: ['pre-shrinking', 'quality_inspection', 'fabric_relaxation'],
      compatibilityRules: ['reactive_dyes_compatible', 'direct_dyes_compatible']
    },
    businessRules: {
      minimumQuantity: 100,
      maximumQuantity: 5000,
      leadTimeDays: 3,
      supplierReferences: ['SUP-CTN-001', 'SUP-CTN-002'],
      seasonalAvailability: true,
      qualityCertifications: ['BIS-14401', 'GOTS-Certified', 'OEKO-TEX-100']
    },
    pricing: {
      salesOrderPricing: [
        { 
      ...
      jobWorkPricing: [], // Not applicable for raw materials
      volumeDiscounts: [
        { thresholdQuantity: 1000, discountPercentage: 5, businessModel: 'sales_order' },
        { thresholdQuantity: 2500, discountPercentage: 8, businessModel: 'sales_order' },
        { thresholdQuantity: 5000, discountPercentage: 12, businessModel: 'sales_order' }
      ]
    },
    metadata: {
      ...
      createdBy: 'system',
      tags: ['cotton', 'white', 'premium', 'textile', 'fabric', 'raw_material']
    }
  },

  {
    id: 'cotton-002',
    code: 'CTN-080-COL',
    name: 'Standard Cotton Fabric - Colored',
    description: '100% cotton fabric, 80 GSM, 44-inch width, pre-dyed in standard colors',
    category: 'raw_material',
    classification: 'material',
    applicability: 'sales_only',
    specifications: {
      ...
      processingRequirements: ['quality_inspection'],
      compatibilityRules: ['limited_further_dyeing']
    },
    businessRules: {
      minimumQuantity: 200,
      maximumQuantity: 3000,
      leadTimeDays: 2,
      supplierReferences: ['SUP-CTN-003'],
      seasonalAvailability: true,
      qualityCertifications: ['BIS-14401']
    },
    pricing: {
      salesOrderPricing: [
        { baseRate: 280, unit: 'per_meter', minimumQuantity: 200, maximumQuantity: 999, currency: 'INR', effectiveDate: '2024-01-01' },
        { baseRate: 260, unit: 'per_meter', minimumQuantity: 1000, currency: 'INR', effectiveDate: '2024-01-01' }
      ],
      jobWorkPricing: [],
      volumeDiscounts: [
        { thresholdQuantity: 1500, discountPercentage: 6, businessModel: 'sales_order' },
        { thresholdQuantity: 3000, discountPercentage: 10, businessModel: 'sales_order' }
      ]
    },
    metadata: {
      createdDate: '2024-01-01',
      ...
      createdBy: 'system',
      tags: ['cotton', 'colored', 'standard', 'textile', 'fabric', 'pre-dyed']
    }
  },

  {
    id: 'silk-001',
    code: 'SLK-150-NTR',
    name: 'Natural Silk Fabric - Raw',
    description: 'Pure mulberry silk fabric, 150 GSM, 42-inch width, natural luster',
    category: 'raw_material',
    classification: 'material',
    applicability: 'sales_only',
    specifications: {
      ...
      qualityGrade: 'premium',
      processingRequirements: ['gentle_handling', 'specialized_processing'],
      compatibilityRules: ['acid_dyes_only', 'low_temperature_processing']
    },
    businessRules: {
      minimumQuantity: 50,
      maximumQuantity: 1000,
      leadTimeDays: 5,
      supplierReferences: ['SUP-SLK-001'],
      seasonalAvailability: false,
      qualityCertifications: ['Silk-Mark-Certified']
    },
    pricing: {
      salesOrderPricing: [
        { baseRate: 1200, unit: 'per_meter', minimumQuantity: 50, maximumQuantity: 199, currency: 'INR', effectiveDate: '2024-01-01' },
        { baseRate: 1150, unit: 'per_meter', minimumQuantity: 200, currency: 'INR', effectiveDate: '2024-01-01' }
      ],
      jobWorkPricing: [],
      volumeDiscounts: [
        { thresholdQuantity: 500, discountPercentage: 4, businessModel: 'sales_order' }
      ]
    },
    metadata: {
      createdDate: '2024-01-01',
      ...
      createdBy: 'system',
      tags: ['silk', 'natural', 'premium', 'luxury', 'mulberry', 'raw_material']
    }
  },

  // ===== ACCESSORIES (Sales Orders Only) =====

  {
    id: 'button-001',
    code: 'BTN-PLT-14MM',
    name: 'Plastic Buttons - 14mm',
    description: 'Standard plastic buttons, 14mm diameter, various colors available',
    category: 'accessory',
    classification: 'material',
    applicability: 'sales_only',
    specifications: {
      technicalParams: {
        ...
        material: 'Plastic',
        thickness: '2.5mm',
        colors: 'White, Black, Brown, Navy, Red'
      },
      qualityGrade: 'standard',
      processingRequirements: ['quality_sorting'],
      compatibilityRules: ['standard_buttonhole_compatible']
    },
    businessRules: {
      minimumQuantity: 1000,
      maximumQuantity: 50000,
      leadTimeDays: 1,
      supplierReferences: ['SUP-BTN-001'],
      seasonalAvailability: true,
      qualityCertifications: ['BIS-Standard']
    },
    pricing: {
      salesOrderPricing: [
        { baseRate: 2.5, unit: 'per_piece', minimumQuantity: 1000, maximumQuantity: 9999, currency: 'INR', effectiveDate: '2024-01-01' },
        { baseRate: 2.2, unit: 'per_piece', minimumQuantity: 10000, currency: 'INR', effectiveDate: '2024-01-01' }
      ],
      jobWorkPricing: [],
      volumeDiscounts: [
        { thresholdQuantity: 25000, discountPercentage: 8, businessModel: 'sales_order' }
      ]
    },
    metadata: {
      createdDate: '2024-01-01',
      ...
      createdBy: 'system',
      tags: ['button', 'plastic', 'accessory', 'standard', '14mm']
    }
  },
...

  {
    id: 'machine-001',
    code: 'MCH-JET-HR',
    name: 'Jet Dyeing Machine - Per Hour',
    description: 'High-efficiency jet dyeing machine rental per hour including operator',
    category: 'equipment_time',
    ...
    specifications: {
      technicalParams: {
        capacity: '500-800 kg',
        efficiency: '95%',
        energyConsumption: '45 kW/hour',
        operatorIncluded: true
      },
      qualityGrade: 'standard',
      processingRequirements: ['trained_operator', 'quality_monitoring'],
      compatibilityRules: ['medium_weight_fabrics', 'jet_dyeing_suitable']
    },
    businessRules: {
      minimumQuantity: 4,
      maximumQuantity: 24,
      ...
      supplierReferences: [],
      seasonalAvailability: true,
      qualityCertifications: ['Machine-Safety-Certified']
    },
    pricing: {
      salesOrderPricing: [
        { baseRate: 2800, unit: 'per_hour', minimumQuantity: 4, currency: 'INR', effectiveDate: '2024-01-01' }
      ],
      jobWorkPricing: [
        { baseRate: 2200, unit: 'per_hour', minimumQuantity: 4, currency: 'INR', effectiveDate: '2024-01-01' }
      ],
      volumeDiscounts: [
        { thresholdQuantity: 12, discountPercentage: 8, businessModel: 'both' },
        { thresholdQuantity: 20, discountPercentage: 15, businessModel: 'job_work' }
      ]
    },
    metadata: {
      createdDate: '2024-01-01',
      lastUpdated: '2024-01-08',
      createdBy: 'system',
      tags: ['machine', 'jet_dyeing', 'equipment', 'hourly', 'operator_included']
    }
  },

  // ===== CONSUMABLES (Sales Orders Only) =====

  {
    id: 'dye-001',
    code: 'DYE-RCT-RED',
    name: 'Reactive Dye - Red',
    description: 'High-quality reactive red dye for cotton and cellulose fibers',
    category: 'consumable',
    ...
    specifications: {
      ...
      qualityGrade: 'standard',
      processingRequirements: ['proper_storage', 'dissolution_check'],
      compatibilityRules: ['cotton_fibers', 'alkaline_conditions']
    },
    businessRules: {
      minimumQuantity: 25,
      maximumQuantity: 500,
      leadTimeDays: 2,
      supplierReferences: ['SUP-DYE-001'],
      seasonalAvailability: true,
      qualityCertifications: ['OEKO-TEX-Eco-Passport']
    },
    pricing: {
      salesOrderPricing: [
        { baseRate: 420, unit: 'per_kg', minimumQuantity: 25, maximumQuantity: 99, currency: 'INR', effectiveDate: '2024-01-01' },
        { baseRate: 380, unit: 'per_kg', minimumQuantity: 100, currency: 'INR', effectiveDate: '2024-01-01' }
      ],
      jobWorkPricing: [],
      volumeDiscounts: [
        { thresholdQuantity: 250, discountPercentage: 8, businessModel: 'sales_order' }
      ]
    },
    metadata: {
      createdDate: '2024-01-01',
      ...
      createdBy: 'system',
      tags: ['dye', 'reactive', 'red', 'consumable', 'cotton', 'chemical']
    }
  }
];
